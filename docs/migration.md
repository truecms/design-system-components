...
1. **Path A: `@gov.au/*` -> `@truecms/*`**
   ...
   - Pin to the current target majors documented in `/Users/ivan/websites/sites/govau/design-system-components/docs/installation/INSTRUCTIONS.md`.
...
Use the full runbook in `/Users/ivan/websites/sites/govau/design-system-components/docs/installation/INSTRUCTIONS.md` for step-by-step execution and version validation.
