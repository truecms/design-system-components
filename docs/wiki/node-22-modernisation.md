...
Logs from these runs should be attached to release pull requests or maintenance issues so compatibility evidence remains auditable.
...
2. Ensure all required documentation and package changelog updates are merged.
...
- Continue recording compatibility runs and escalations in release pull requests or maintenance issues to satisfy monitoring requirement FR-005.
