...
* v9.0.1 - Patch release: security dependency updates and CI hardening (2026.05.31)
* v9.0.0 - Major release: removed legacy Pancake build coupling (postinstall hook, pancake config, @truecms/pancake* dependencies)
