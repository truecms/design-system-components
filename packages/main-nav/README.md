...
* v3.0.2 - Patch release: security dependency updates and CI hardening (2026.05.31)
* v3.0.0 - Major release: removed legacy Pancake build coupling (postinstall hook, pancake config, @truecms/pancake* dependencies)
